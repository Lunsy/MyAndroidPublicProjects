...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsButton = findViewById(R.id.settings_Driver_Button);
        signOutButton = findViewById(R.id.sign_out_Driver_Button);
    ...
    private void updateLocationUI() {
        ...
        if (currentLocation != null){
            ...
            DatabaseReference driversGeoFire = FirebaseDatabase.getInstance(
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (requestCode == CHECK_SETTINGS_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                Log.d("DriverMapsActivity", "User has agreed to changes" +
                        "settings");
                startLocationUpdates();
            }
            if (requestCode == Activity.RESULT_CANCELED) {
                Log.d("DriverMapsActivity", "User has not agreed to changes" +
                        "settings");
                isLocationUpdatesActive = false;
