package com.kayrat.mvvmretrofitdemo.adapter;
...
import com.kayrat.mvvmretrofitdemo.view.MovieDetailsActivity;
...
public class ResultAdapter
    ...
    @Override
    public void onBindViewHolder(@NonNull ResultViewHolder holder,
                                 int position) {

        holder.titleTextView.setText(results.get(position).getOriginalTitle());
        holder.popularityTextView.
                setText(Double.toString(results.get(position).getPopularity()));
