...
public class Utils {
    ...
    public static final String PIZZA_1_NAME = "Caramelised onion & goat's cheese pizza";
    ...
    public static final String PIZZA_4_NAME = "Chicken tikka masala pizzas";
    public static final String PIZZA_4_DESCRIPTION = "Rustle up our spiced chicken pizzas using naan bread in just 20 minutes. To balance the heat, serve them with dollops of mango chutney and natural yogurt";
    public static final String PIZZA_4_RECIPE = "Heat oven to 180C/160C fan/gas 4. Toss the red onion with the red wine vinegar and a good pinch of salt and set aside (the vinegar will soften the onion slightly, which is a blessing as no one wants completely raw onion on pizza).\n" +
            "\n" +
    ...
    public static final String PIZZA_5_NAME = "Rainbow pizzas";
    public static final String PIZZA_5_DESCRIPTION = "Forget takeaway pizzas, encourage kids to eat a rainbow every day with this colourful recipe full of fresh flavours – guaranteed to please even fussy eaters...";
    public static final String PIZZA_5_RECIPE = "Heat the oven to 180C/160C fan/gas 4. Put each pizza base on a baking sheet and spread each with half of the passata. Arrange the tomatoes on the top in rings or wedges of colour and add the broccoli and the olives, if using. Squish the mozzarella cherries (bocconcini) a little before dotting them over the pizzas, then drizzle 1 tbsp pesto over each.\n" +
            "\n" +
    ...
    public static final String PIZZA_6_NAME = "Pork, gorgonzola & garlic butter pizza";
    public static final String PIZZA_6_DESCRIPTION = "Garlic butter, salty blue cheese, peppery rocket and a kick of chilli – these pizzas are loaded with flavour. Try making them for an indulgent weekend dinner...";
    public static final String PIZZA_6_RECIPE = "To make the dough, put the flour, yeast and 1 tsp salt into the bowl of an electric mixer with a dough hook. On a medium speed, gradually pour in the oil and 200ml warm water to make a dough. Alternatively, mix by hand and knead on a floured surface. Cover the bowl with cling film and prove for 1 hr or until doubled in size.\n" +
            "\n" +
    ...
    public static final String PIZZA_7_NAME = "Spinach & blue cheese pizza";
    public static final String PIZZA_7_DESCRIPTION = "This vegetarian pizza is super-quick to make because the base is yeast free. Packed with spinach, walnuts, mushrooms and blue cheese, it's super-tasty too...";
    ...
    public static final String PIZZA_8_NAME = "Pizza Margherita in 4 easy steps";
    public static final String PIZZA_8_DESCRIPTION = "Even a novice cook can master the art of pizza with our simple step-by-step guide. Bellissimo";
    public static final String PIZZA_8_RECIPE = "Make the base: Put the flour into a large bowl, then stir in the yeast and salt. Make a well, pour in 200ml warm water and the olive oil and bring together with a wooden spoon until you have a soft, fairly wet dough. Turn onto a lightly floured surface and knead for 5 mins until smooth. Cover with a tea towel and set aside. You can leave the dough to rise if you like, but it’s not essential for a thin crust.\n" +
            "\n" +
    ...
    public static final String PIZZA_9_NAME = "Spelt pizza bianco with Jersey Royals";
    public static final String PIZZA_9_DESCRIPTION = "Spelt has a wonderful nutty flavour that works particularly well for pizza. This is a twist on classic comfort food, with Jersey Royal potatoes and herbs";
    public static final String PIZZA_9_RECIPE = "Make the biga the night before. Mix the two flours, yeast and sugar in a bowl. Slowly add 150ml lukewarm water and stir to create a thick batter. Cover with a plastic carrier bag or dry tea towel and leave in a warm place overnight to ferment.\n" +
            "\n" +
